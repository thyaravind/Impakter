  ...
  _createClass(SelectPure, [{
    ...
    value: function _handleClick(event) {
      ...
      if (this._state.opened) {
        ...
        if (option) {
          this._setValue(option.get().getAttribute("ProjectData-value"), true);
        }
      ...
      if (this._config.multiple) {
        var options = this._config.value.map(function (_value) {
          ...
          var optionNode = _this2._options.find(function (_option) {
            return _option.get().getAttribute("ProjectData-value") === option.value.toString();
          });
    ...
    value: function _unselectOption(event) {
      ...
      var index = newValue.indexOf(event.target.getAttribute("ProjectData-value")); // eslint-disable-next-line no-magic-numbers
